...
enum eMatePreferences {
  ...
  MATE_PREFERENCE_TARGET_DISPLAY_A,
  MATE_PREFERENCE_TARGET_DISPLAY_B
};

enum eGenotypeClassifierDetailControl {
  GENOTYPE_CLASSIFIER_ENABLED,
  GENOTYPE_CLASSIFIER_PARENT_TRACKING_DISABLED,
  GENOTYPE_CLASSIFIER_LIGHT_PARENT_TRACKING
};
