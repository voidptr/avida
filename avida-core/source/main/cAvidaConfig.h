...
#include "config_overrides.h"
  ...
  CONFIG_ADD_VAR(DISPLAY_C_DEADLY_RANGE_BEGIN, int, -1, "Prevent 50% of organisms that display a C trait starting here from mating.");
  CONFIG_ADD_VAR(DISPLAY_C_DEADLY_RANGE_END, int, -1, "Prevent 50% of organisms that display a C trait ending here from mating.");
