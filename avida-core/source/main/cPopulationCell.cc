 ...
 */
void cPopulationCell::AddGenomeFragments(cAvidaContext& ctx, const InstructionSequence& genome, const int update_born) {
...
std::deque<int>& cPopulationCell::GetFragmentsUpdates() {
    InitHGTSupport();
