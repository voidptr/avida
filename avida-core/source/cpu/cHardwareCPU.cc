...
tInstLib<cHardwareCPU::tMethod> *cHardwareCPU::initInstLib(void) {
     ...
     */
            tInstLibEntry<tMethod>("nop-A", &cHardwareCPU::Inst_Nop, INST_CLASS_NOP,
                                   (nInstFlag::DEFAULT | nInstFlag::NOP),
                                   "No-operation instruction; modifies other instructions"),
            tInstLibEntry<tMethod>("nop-B", &cHardwareCPU::Inst_Nop, INST_CLASS_NOP,
                                   (nInstFlag::DEFAULT | nInstFlag::NOP),
                                   "No-operation instruction; modifies other instructions"),
            tInstLibEntry<tMethod>("nop-C", &cHardwareCPU::Inst_Nop, INST_CLASS_NOP,
                                   (nInstFlag::DEFAULT | nInstFlag::NOP),
                                   "No-operation instruction; modifies other instructions"),

            tInstLibEntry<tMethod>("nop-X", &cHardwareCPU::Inst_Nop, INST_CLASS_NOP, 0,
                                   "True no-operation instruction: does nothing"),
            tInstLibEntry<tMethod>("nop-Y", &cHardwareCPU::Inst_Nop, INST_CLASS_NOP, 0,
                                   "True no-operation instruction: does nothing"),
            tInstLibEntry<tMethod>("if-equ-0", &cHardwareCPU::Inst_If0, INST_CLASS_CONDITIONAL, 0,
                                   "Execute next instruction if ?BX?==0, else skip it"),
            tInstLibEntry<tMethod>("if-not-0", &cHardwareCPU::Inst_IfNot0, INST_CLASS_CONDITIONAL, 0,
                                   "Execute next instruction if ?BX?!=0, else skip it"),
            tInstLibEntry<tMethod>("if-equ-0-defaultAX", &cHardwareCPU::Inst_If0_defaultAX, INST_CLASS_CONDITIONAL, 0,
                                   "Execute next instruction if ?AX?==0, else skip it"),
            tInstLibEntry<tMethod>("if-not-0-defaultAX", &cHardwareCPU::Inst_IfNot0_defaultAX, INST_CLASS_CONDITIONAL,
                                   0, "Execute next instruction if ?AX?!=0, else skip it"),
            tInstLibEntry<tMethod>("if-n-equ", &cHardwareCPU::Inst_IfNEqu, INST_CLASS_CONDITIONAL, nInstFlag::DEFAULT,
                                   "Execute next instruction if ?BX?!=?CX?, else skip it"),
            tInstLibEntry<tMethod>("if-equ", &cHardwareCPU::Inst_IfEqu, INST_CLASS_CONDITIONAL, 0,
                                   "Execute next instruction if ?BX?==?CX?, else skip it"),
            ...
            tInstLibEntry<tMethod>("if-less", &cHardwareCPU::Inst_IfLess, INST_CLASS_CONDITIONAL, nInstFlag::DEFAULT,
                                   "Execute next instruction if ?BX? < ?CX?, else skip it"),
            ...
            tInstLibEntry<tMethod>("pop", &cHardwareCPU::Inst_Pop, INST_CLASS_DATA, nInstFlag::DEFAULT,
                                   "Remove top number from stack and place into ?BX?"),
            tInstLibEntry<tMethod>("push", &cHardwareCPU::Inst_Push, INST_CLASS_DATA, nInstFlag::DEFAULT,
                                   "Copy number from ?BX? and place it into the stack"),
            tInstLibEntry<tMethod>("swap-stk", &cHardwareCPU::Inst_SwitchStack, INST_CLASS_DATA, nInstFlag::DEFAULT,
                                   "Toggle which stack is currently being used"),
            tInstLibEntry<tMethod>("flip-stk", &cHardwareCPU::Inst_FlipStack, INST_CLASS_DATA),
            tInstLibEntry<tMethod>("swap", &cHardwareCPU::Inst_Swap, INST_CLASS_DATA, nInstFlag::DEFAULT,
            ...
            tInstLibEntry<tMethod>("shift-r", &cHardwareCPU::Inst_ShiftR, INST_CLASS_ARITHMETIC_LOGIC,
                                   nInstFlag::DEFAULT, "Shift bits in ?BX? right by one (divide by two)"),
            tInstLibEntry<tMethod>("shift-l", &cHardwareCPU::Inst_ShiftL, INST_CLASS_ARITHMETIC_LOGIC,
                                   nInstFlag::DEFAULT, "Shift bits in ?BX? left by one (multiply by two)"),
            ...
            tInstLibEntry<tMethod>("inc", &cHardwareCPU::Inst_Inc, INST_CLASS_ARITHMETIC_LOGIC, nInstFlag::DEFAULT,
                                   "Increment ?BX? by one"),
            tInstLibEntry<tMethod>("dec", &cHardwareCPU::Inst_Dec, INST_CLASS_ARITHMETIC_LOGIC, nInstFlag::DEFAULT,
                                   "Decrement ?BX? by one"),
            tInstLibEntry<tMethod>("zero", &cHardwareCPU::Inst_Zero, INST_CLASS_ARITHMETIC_LOGIC, 0,
                                   "Set ?BX? to zero"),
            tInstLibEntry<tMethod>("one", &cHardwareCPU::Inst_One, INST_CLASS_ARITHMETIC_LOGIC, 0, "Set ?BX? to one"),
            tInstLibEntry<tMethod>("all1s", &cHardwareCPU::Inst_All1s, INST_CLASS_ARITHMETIC_LOGIC, 0,
                                   "Set ?BX? to all 1s in bitstring"),
            ...
            tInstLibEntry<tMethod>("add", &cHardwareCPU::Inst_Add, INST_CLASS_ARITHMETIC_LOGIC, nInstFlag::DEFAULT,
                                   "Add BX to CX and place the result in ?BX?"),
            tInstLibEntry<tMethod>("sub", &cHardwareCPU::Inst_Sub, INST_CLASS_ARITHMETIC_LOGIC, nInstFlag::DEFAULT,
                                   "Subtract CX from BX and place the result in ?BX?"),
            tInstLibEntry<tMethod>("mult", &cHardwareCPU::Inst_Mult, INST_CLASS_ARITHMETIC_LOGIC, 0,
                                   "Multiple BX by CX and place the result in ?BX?"),
            tInstLibEntry<tMethod>("div", &cHardwareCPU::Inst_Div, INST_CLASS_ARITHMETIC_LOGIC, 0,
                                   "Divide BX by CX and place the result in ?BX?"),
            tInstLibEntry<tMethod>("mod", &cHardwareCPU::Inst_Mod, INST_CLASS_ARITHMETIC_LOGIC),
            tInstLibEntry<tMethod>("nand", &cHardwareCPU::Inst_Nand, INST_CLASS_ARITHMETIC_LOGIC, nInstFlag::DEFAULT,
            ...
            tInstLibEntry<tMethod>("setbit", &cHardwareCPU::Inst_Setbit, INST_CLASS_ARITHMETIC_LOGIC,
                                   nInstFlag::DEFAULT, "Set the bit in ?BX? specified by ?BX?'s complement"),
            tInstLibEntry<tMethod>("clearbit", &cHardwareCPU::Inst_Clearbit, INST_CLASS_ARITHMETIC_LOGIC,
                                   nInstFlag::DEFAULT, "Clear the bit in ?BX? specified by ?BX?'s complement"),

            // treatable instructions
            tInstLibEntry<tMethod>("nand-treatable", &cHardwareCPU::Inst_NandTreatable, INST_CLASS_ARITHMETIC_LOGIC,
                                   nInstFlag::DEFAULT,
                                   "Nand BX by CX and place the result in ?BX?, fails if deme is treatable"),
            ...
            tInstLibEntry<tMethod>("stk-get", &cHardwareCPU::Inst_TaskStackGet, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("stk-load", &cHardwareCPU::Inst_TaskStackLoad, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("put", &cHardwareCPU::Inst_TaskPut, INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("put-reset", &cHardwareCPU::Inst_TaskPutResetInputs, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("IO", &cHardwareCPU::Inst_TaskIO, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::DEFAULT | nInstFlag::STALL,
                                   "Output ?BX?, and input new number back into ?BX?"),
            tInstLibEntry<tMethod>("IO-Feedback", &cHardwareCPU::Inst_TaskIO_Feedback, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL,
                                   "Output ?BX?, and input new number back into ?BX?,  and push 1,0,  or -1 onto stack1 if merit increased, stayed the same, or decreased"),
            tInstLibEntry<tMethod>("IO-bc-0.001", &cHardwareCPU::Inst_TaskIO_BonusCost_0_001, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("match-strings", &cHardwareCPU::Inst_MatchStrings, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            ...
            tInstLibEntry<tMethod>("sense", &cHardwareCPU::Inst_SenseLog2, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),           // If you add more sense instructions
            tInstLibEntry<tMethod>("sense-unit", &cHardwareCPU::Inst_SenseUnit, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),      // and want to keep stats, also add
            tInstLibEntry<tMethod>("sense-m100", &cHardwareCPU::Inst_SenseMult100, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),   // the names to cStats::cStats() @JEB
            tInstLibEntry<tMethod>("sense-resource-id", &cHardwareCPU::Inst_SenseResourceID, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("sense-opinion-resource-quantity", &cHardwareCPU::Inst_SenseOpinionResourceQuantity,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("sense-next-res-level", &cHardwareCPU::Inst_SenseNextResLevel,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL), // @JJB
            tInstLibEntry<tMethod>("sense-diff-faced", &cHardwareCPU::Inst_SenseDiffFaced, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("sense-faced-habitat", &cHardwareCPU::Inst_SenseFacedHabitat, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),

            tInstLibEntry<tMethod>("sense-resource0", &cHardwareCPU::Inst_SenseResource0, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("sense-resource1", &cHardwareCPU::Inst_SenseResource1, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("sense-resource2", &cHardwareCPU::Inst_SenseResource2, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("sense-faced-resource0", &cHardwareCPU::Inst_SenseFacedResource0,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("sense-faced-resource1", &cHardwareCPU::Inst_SenseFacedResource1,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("sense-faced-resource2", &cHardwareCPU::Inst_SenseFacedResource2,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),

            tInstLibEntry<tMethod>("if-resources", &cHardwareCPU::Inst_IfResources, INST_CLASS_CONDITIONAL,
                                   nInstFlag::STALL),
            ...
            tInstLibEntry<tMethod>("collect-unit-prob", &cHardwareCPU::Inst_CollectUnitProbabilistic,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("collect-specific", &cHardwareCPU::Inst_CollectSpecific, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("collect-needed", &cHardwareCPU::Inst_CollectSpecificNeeded, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("collect-specific-ratio", &cHardwareCPU::Inst_CollectSpecificRatio,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            ...
            tInstLibEntry<tMethod>("receive-donated-energy", &cHardwareCPU::Inst_ReceiveDonatedEnergy,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("donate-energy", &cHardwareCPU::Inst_DonateEnergy, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("update-metabolic-rate", &cHardwareCPU::Inst_UpdateMetabolicRate,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("donate-energy-faced", &cHardwareCPU::Inst_DonateEnergyFaced, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("donate-energy-faced1", &cHardwareCPU::Inst_DonateEnergyFaced1,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("donate-energy-faced2", &cHardwareCPU::Inst_DonateEnergyFaced2,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("donate-energy-faced5", &cHardwareCPU::Inst_DonateEnergyFaced5,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("donate-energy-faced10", &cHardwareCPU::Inst_DonateEnergyFaced10,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("donate-energy-faced20", &cHardwareCPU::Inst_DonateEnergyFaced20,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("donate-energy-faced50", &cHardwareCPU::Inst_DonateEnergyFaced50,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("donate-energy-faced100", &cHardwareCPU::Inst_DonateEnergyFaced100,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("rotate-to-most-needy", &cHardwareCPU::Inst_RotateToMostNeedy,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("request-energy", &cHardwareCPU::Inst_RequestEnergy, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("request-energy-on", &cHardwareCPU::Inst_RequestEnergyFlagOn, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("request-energy-off", &cHardwareCPU::Inst_RequestEnergyFlagOff,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("increase-energy-donation", &cHardwareCPU::Inst_IncreaseEnergyDonation,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("decrease-energy-donation", &cHardwareCPU::Inst_DecreaseEnergyDonation,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("donate-resource0", &cHardwareCPU::Inst_DonateResource0, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("donate-resource1", &cHardwareCPU::Inst_DonateResource1, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("donate-resource2", &cHardwareCPU::Inst_DonateResource2, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("IObuf-add1", &cHardwareCPU::Inst_IOBufAdd1, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("IObuf-add0", &cHardwareCPU::Inst_IOBufAdd0, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("donate-specific", &cHardwareCPU::Inst_DonateSpecific, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            ...
            tInstLibEntry<tMethod>("rotate-left-one", &cHardwareCPU::Inst_RotateLeftOne, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("rotate-right-one", &cHardwareCPU::Inst_RotateRightOne, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("rotate-label", &cHardwareCPU::Inst_RotateLabel, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("rotate-to-unoccupied-cell", &cHardwareCPU::Inst_RotateUnoccupiedCell,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("rotate-to-next-unoccupied-cell", &cHardwareCPU::Inst_RotateNextUnoccupiedCell,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("rotate-to-occupied-cell", &cHardwareCPU::Inst_RotateOccupiedCell,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("rotate-to-next-occupied-cell", &cHardwareCPU::Inst_RotateNextOccupiedCell,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("rotate-to-event-cell", &cHardwareCPU::Inst_RotateEventCell, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("rotate-uphill", &cHardwareCPU::Inst_RotateUphill, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("rotate-home", &cHardwareCPU::Inst_RotateHome, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            ...
            tInstLibEntry<tMethod>("move-to-event", &cHardwareCPU::Inst_MoveToEvent, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("if-event-in-unoccupied-neighbor-cell",
                                   &cHardwareCPU::Inst_IfNeighborEventInUnoccupiedCell),
            ...
            tInstLibEntry<tMethod>("h-alloc", &cHardwareCPU::Inst_MaxAlloc, INST_CLASS_LIFECYCLE, nInstFlag::DEFAULT,
                                   "Allocate maximum allowed space"),
            tInstLibEntry<tMethod>("h-alloc-mw", &cHardwareCPU::Inst_MaxAllocMoveWriteHead),
            tInstLibEntry<tMethod>("h-divide", &cHardwareCPU::Inst_HeadDivide, INST_CLASS_LIFECYCLE,
                                   nInstFlag::DEFAULT | nInstFlag::STALL, "Divide code between read and write heads."),
            tInstLibEntry<tMethod>("h-divide1RS", &cHardwareCPU::Inst_HeadDivide1RS, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL,
                                   "Divide code between read and write heads, at most one mutation on divide, resample if reverted."),
            tInstLibEntry<tMethod>("h-divide2RS", &cHardwareCPU::Inst_HeadDivide2RS, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL,
                                   "Divide code between read and write heads, at most two mutations on divide, resample if reverted."),
            tInstLibEntry<tMethod>("h-divideRS", &cHardwareCPU::Inst_HeadDivideRS, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL, "Divide code between read and write heads, resample if reverted."),
            ...
            tInstLibEntry<tMethod>("h-copy", &cHardwareCPU::Inst_HeadCopy, INST_CLASS_LIFECYCLE, nInstFlag::DEFAULT,
                                   "Copy from read-head to write-head; advance both"),
            tInstLibEntry<tMethod>("h-search", &cHardwareCPU::Inst_HeadSearch, INST_CLASS_FLOW_CONTROL,
                                   nInstFlag::DEFAULT, "Find complement template and make with flow head"),
            tInstLibEntry<tMethod>("h-search-direct", &cHardwareCPU::Inst_HeadSearchDirect, INST_CLASS_FLOW_CONTROL, 0,
                                   "Find direct template and move the flow head"),
            ...
            tInstLibEntry<tMethod>("mov-head", &cHardwareCPU::Inst_MoveHead, INST_CLASS_FLOW_CONTROL,
                                   nInstFlag::DEFAULT, "Move head ?IP? to the flow head"),
            tInstLibEntry<tMethod>("jmp-head", &cHardwareCPU::Inst_JumpHead, INST_CLASS_FLOW_CONTROL,
                                   nInstFlag::DEFAULT, "Move head ?IP? by amount in CX register; CX = old pos."),
            tInstLibEntry<tMethod>("get-head", &cHardwareCPU::Inst_GetHead, INST_CLASS_FLOW_CONTROL, nInstFlag::DEFAULT,
                                   "Copy the position of the ?IP? head into CX"),
            tInstLibEntry<tMethod>("if-label", &cHardwareCPU::Inst_IfLabel, INST_CLASS_CONDITIONAL, nInstFlag::DEFAULT,
                                   "Execute next if we copied complement of attached label"),
            tInstLibEntry<tMethod>("if-label-direct", &cHardwareCPU::Inst_IfLabelDirect, INST_CLASS_CONDITIONAL,
                                   nInstFlag::DEFAULT, "Execute next if we copied direct match of the attached label"),
            tInstLibEntry<tMethod>("if-label2", &cHardwareCPU::Inst_IfLabel2, INST_CLASS_CONDITIONAL, 0,
                                   "If copied label compl., exec next inst; else SKIP W/NOPS"),
            tInstLibEntry<tMethod>("set-flow", &cHardwareCPU::Inst_SetFlow, INST_CLASS_FLOW_CONTROL, nInstFlag::DEFAULT,
                                   "Set flow-head to position in ?CX?"),

            tInstLibEntry<tMethod>("res-mov-head", &cHardwareCPU::Inst_ResMoveHead, INST_CLASS_FLOW_CONTROL,
                                   nInstFlag::STALL, "Move head ?IP? to the flow head depending on resource level"),
            tInstLibEntry<tMethod>("res-jmp-head", &cHardwareCPU::Inst_ResJumpHead, INST_CLASS_FLOW_CONTROL,
                                   nInstFlag::STALL,
                                   "Move head ?IP? by amount in CX register depending on resource level; CX = old pos."),

            tInstLibEntry<tMethod>("h-copy-res", &cHardwareCPU::Inst_HeadCopy_ifResource, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL,
                                   "Copy from read-head to write-head if specific resource 1 is available; advance both"),
            ...
            tInstLibEntry<tMethod>("divide-sex", &cHardwareCPU::Inst_HeadDivideSex, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("divide-asex", &cHardwareCPU::Inst_HeadDivideAsex, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),

            tInstLibEntry<tMethod>("div-sex", &cHardwareCPU::Inst_HeadDivideSex, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("div-asex", &cHardwareCPU::Inst_HeadDivideAsex, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("div-asex-w", &cHardwareCPU::Inst_HeadDivideAsexWait, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("div-sex-MS", &cHardwareCPU::Inst_HeadDivideMateSelect, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),

            tInstLibEntry<tMethod>("h-divide1", &cHardwareCPU::Inst_HeadDivide1, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("h-divide2", &cHardwareCPU::Inst_HeadDivide2, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("h-divide3", &cHardwareCPU::Inst_HeadDivide3, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("h-divide4", &cHardwareCPU::Inst_HeadDivide4, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("h-divide5", &cHardwareCPU::Inst_HeadDivide5, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("h-divide6", &cHardwareCPU::Inst_HeadDivide6, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("h-divide7", &cHardwareCPU::Inst_HeadDivide7, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("h-divide8", &cHardwareCPU::Inst_HeadDivide8, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("h-divide9", &cHardwareCPU::Inst_HeadDivide9, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("h-divide10", &cHardwareCPU::Inst_HeadDivide10, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("h-divide16", &cHardwareCPU::Inst_HeadDivide16, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("h-divide32", &cHardwareCPU::Inst_HeadDivide32, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("h-divide50", &cHardwareCPU::Inst_HeadDivide50, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("h-divide100", &cHardwareCPU::Inst_HeadDivide100, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("h-divide500", &cHardwareCPU::Inst_HeadDivide500, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("h-divide1000", &cHardwareCPU::Inst_HeadDivide1000, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("h-divide5000", &cHardwareCPU::Inst_HeadDivide5000, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("h-divide10000", &cHardwareCPU::Inst_HeadDivide10000, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("h-divide50000", &cHardwareCPU::Inst_HeadDivide50000, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("h-divide0.5", &cHardwareCPU::Inst_HeadDivide0_5, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("h-divide0.1", &cHardwareCPU::Inst_HeadDivide0_1, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("h-divide0.05", &cHardwareCPU::Inst_HeadDivide0_05, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("h-divide0.01", &cHardwareCPU::Inst_HeadDivide0_01, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("h-divide0.001", &cHardwareCPU::Inst_HeadDivide0_001, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            ...
            tInstLibEntry<tMethod>("set-mating-type-juvenile", &cHardwareCPU::Inst_SetMatingTypeJuvenile,
                                   INST_CLASS_LIFECYCLE),
            tInstLibEntry<tMethod>("div-sex-mating-type", &cHardwareCPU::Inst_DivideSexMatingType, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            ...
            tInstLibEntry<tMethod>("set-mate-preference-random", &cHardwareCPU::Inst_SetMatePreferenceRandom,
                                   INST_CLASS_LIFECYCLE),
            tInstLibEntry<tMethod>("set-mate-preference-highest-display-a",
                                   &cHardwareCPU::Inst_SetMatePreferenceHighestDisplayA, INST_CLASS_LIFECYCLE),
            tInstLibEntry<tMethod>("set-mate-preference-highest-display-b",
                                   &cHardwareCPU::Inst_SetMatePreferenceHighestDisplayB, INST_CLASS_LIFECYCLE),
            tInstLibEntry<tMethod>("set-mate-preference-highest-merit",
                                   &cHardwareCPU::Inst_SetMatePreferenceHighestMerit, INST_CLASS_LIFECYCLE),
            tInstLibEntry<tMethod>("set-mate-preference-lowest-display-a",
                                   &cHardwareCPU::Inst_SetMatePreferenceLowestDisplayA, INST_CLASS_LIFECYCLE),
            tInstLibEntry<tMethod>("set-mate-preference-lowest-display-b",
                                   &cHardwareCPU::Inst_SetMatePreferenceLowestDisplayB, INST_CLASS_LIFECYCLE),
            tInstLibEntry<tMethod>("set-mate-preference-lowest-merit", &cHardwareCPU::Inst_SetMatePreferenceLowestMerit,
                                   INST_CLASS_LIFECYCLE),
            ...
            tInstLibEntry<tMethod>("repro-germ-flag", &cHardwareCPU::Inst_ReproGermFlag, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            ...
            tInstLibEntry<tMethod>("cond-repro", &cHardwareCPU::Inst_ConditionalRepro, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),

            tInstLibEntry<tMethod>("put-repro", &cHardwareCPU::Inst_TaskPutRepro, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("metabolize", &cHardwareCPU::Inst_TaskPutResetInputsRepro, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            ...
            tInstLibEntry<tMethod>("smart-explode", &cHardwareCPU::Inst_SmartExplode, INST_CLASS_OTHER,
                                   nInstFlag::STALL),
            ...
            tInstLibEntry<tMethod>("relinquishEnergyToFutureDeme", &cHardwareCPU::Inst_RelinquishEnergyToFutureDeme,
                                   INST_CLASS_OTHER, nInstFlag::STALL),
            tInstLibEntry<tMethod>("relinquishEnergyToNeighborOrganisms",
                                   &cHardwareCPU::Inst_RelinquishEnergyToNeighborOrganisms, INST_CLASS_OTHER,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("relinquishEnergyToOrganismsInDeme",
                                   &cHardwareCPU::Inst_RelinquishEnergyToOrganismsInDeme, INST_CLASS_OTHER,
                                   nInstFlag::STALL),

            // Energy level detection
            tInstLibEntry<tMethod>("if-energy-low", &cHardwareCPU::Inst_IfEnergyLow, INST_CLASS_CONDITIONAL,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("if-energy-not-low", &cHardwareCPU::Inst_IfEnergyNotLow, INST_CLASS_CONDITIONAL,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("if-faced-energy-low", &cHardwareCPU::Inst_IfFacedEnergyLow, INST_CLASS_CONDITIONAL,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("if-faced-energy-not-low", &cHardwareCPU::Inst_IfFacedEnergyNotLow,
                                   INST_CLASS_CONDITIONAL, nInstFlag::STALL),
            tInstLibEntry<tMethod>("if-energy-high", &cHardwareCPU::Inst_IfEnergyHigh, INST_CLASS_CONDITIONAL,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("if-energy-not-high", &cHardwareCPU::Inst_IfEnergyNotHigh, INST_CLASS_CONDITIONAL,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("if-faced-energy-high", &cHardwareCPU::Inst_IfFacedEnergyHigh,
                                   INST_CLASS_CONDITIONAL, nInstFlag::STALL),
            tInstLibEntry<tMethod>("if-faced-energy-not-high", &cHardwareCPU::Inst_IfFacedEnergyNotHigh,
                                   INST_CLASS_CONDITIONAL, nInstFlag::STALL),
            tInstLibEntry<tMethod>("if-energy-med", &cHardwareCPU::Inst_IfEnergyMed, INST_CLASS_CONDITIONAL,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("if-faced-energy-med", &cHardwareCPU::Inst_IfFacedEnergyMed, INST_CLASS_CONDITIONAL,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("if-faced-energy-less", &cHardwareCPU::Inst_IfFacedEnergyLess,
                                   INST_CLASS_CONDITIONAL, nInstFlag::STALL),
            tInstLibEntry<tMethod>("if-faced-energy-more", &cHardwareCPU::Inst_IfFacedEnergyMore,
                                   INST_CLASS_CONDITIONAL, nInstFlag::STALL),
            tInstLibEntry<tMethod>("if-energy-in-buffer", &cHardwareCPU::Inst_IfEnergyInBuffer, INST_CLASS_CONDITIONAL,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("if-energy-not-in-buffer", &cHardwareCPU::Inst_IfEnergyNotInBuffer,
                                   INST_CLASS_CONDITIONAL, nInstFlag::STALL),
            tInstLibEntry<tMethod>("get-energy-level", &cHardwareCPU::Inst_GetEnergyLevel, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("get-faced-energy-level", &cHardwareCPU::Inst_GetFacedEnergyLevel,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("if-faced-request-on", &cHardwareCPU::Inst_IfFacedEnergyRequestOn,
                                   INST_CLASS_CONDITIONAL, nInstFlag::STALL),
            tInstLibEntry<tMethod>("if-faced-request-off", &cHardwareCPU::Inst_IfFacedEnergyRequestOff,
                                   INST_CLASS_CONDITIONAL, nInstFlag::STALL),
            tInstLibEntry<tMethod>("get-energy-request-status", &cHardwareCPU::Inst_GetEnergyRequestStatus,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("get-faced-energy-request-status", &cHardwareCPU::Inst_GetFacedEnergyRequestStatus,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),


            // Sleep and time
            tInstLibEntry<tMethod>("sleep", &cHardwareCPU::Inst_Sleep, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL | nInstFlag::SLEEP),
            tInstLibEntry<tMethod>("sleep1", &cHardwareCPU::Inst_Sleep, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL | nInstFlag::SLEEP),
            tInstLibEntry<tMethod>("sleep2", &cHardwareCPU::Inst_Sleep, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL | nInstFlag::SLEEP),
            tInstLibEntry<tMethod>("sleep3", &cHardwareCPU::Inst_Sleep, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL | nInstFlag::SLEEP),
            tInstLibEntry<tMethod>("sleep4", &cHardwareCPU::Inst_Sleep, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL | nInstFlag::SLEEP),
            ...
            tInstLibEntry<tMethod>("if-cons", &cHardwareCPU::Inst_IfConsensus, INST_CLASS_CONDITIONAL, 0,
                                   "Execute next instruction if ?BX? in consensus, else skip it"),
            tInstLibEntry<tMethod>("if-cons-24", &cHardwareCPU::Inst_IfConsensus24, INST_CLASS_CONDITIONAL, 0,
                                   "Execute next instruction if ?BX[0:23]? in consensus , else skip it"),
            tInstLibEntry<tMethod>("if-less-cons", &cHardwareCPU::Inst_IfLessConsensus, INST_CLASS_CONDITIONAL, 0,
                                   "Execute next instruction if Count(?BX?) < Count(?CX?), else skip it"),
            tInstLibEntry<tMethod>("if-less-cons-24", &cHardwareCPU::Inst_IfLessConsensus24, INST_CLASS_CONDITIONAL, 0,
                                   "Execute next instruction if Count(?BX[0:23]?) < Count(?CX[0:23]?), else skip it"),
            ...
            // Energy usage
            tInstLibEntry<tMethod>("double-energy-usage", &cHardwareCPU::Inst_DoubleEnergyUsage, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("halve-energy-usage", &cHardwareCPU::Inst_HalveEnergyUsage, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("default-energy-usage", &cHardwareCPU::Inst_DefaultEnergyUsage, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),

            // Messaging
            tInstLibEntry<tMethod>("send-msg", &cHardwareCPU::Inst_SendMessage, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("retrieve-msg", &cHardwareCPU::Inst_RetrieveMessage, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            ...
            // Alarms
            tInstLibEntry<tMethod>("send-alarm-msg-local", &cHardwareCPU::Inst_Alarm_MSG_local, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("send-alarm-msg-multihop", &cHardwareCPU::Inst_Alarm_MSG_multihop,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("send-alarm-msg-bit-cons24-local", &cHardwareCPU::Inst_Alarm_MSG_Bit_Cons24_local,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("send-alarm-msg-bit-cons24-multihop",
                                   &cHardwareCPU::Inst_Alarm_MSG_Bit_Cons24_multihop, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            ...
            // Interrupt
            tInstLibEntry<tMethod>("send-msg-interrupt-type0", &cHardwareCPU::Inst_SendMessageInterruptType0,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("send-msg-interrupt-type1", &cHardwareCPU::Inst_SendMessageInterruptType1,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("send-msg-interrupt-type2", &cHardwareCPU::Inst_SendMessageInterruptType2,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("send-msg-interrupt-type3", &cHardwareCPU::Inst_SendMessageInterruptType3,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("send-msg-interrupt-type4", &cHardwareCPU::Inst_SendMessageInterruptType4,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("send-msg-interrupt-type5", &cHardwareCPU::Inst_SendMessageInterruptType5,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            ...
            tInstLibEntry<tMethod>("sense-pheromone-global-defaultAX",
                                   &cHardwareCPU::Inst_SensePheromoneGlobal_defaultAX),
            tInstLibEntry<tMethod>("exploit", &cHardwareCPU::Inst_Exploit, INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("exploit-forward5", &cHardwareCPU::Inst_ExploitForward5, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("exploit-forward3", &cHardwareCPU::Inst_ExploitForward3, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("explore", &cHardwareCPU::Inst_Explore, INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("movetarget", &cHardwareCPU::Inst_MoveTarget, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            ...
            tInstLibEntry<tMethod>("movetarget-forward3", &cHardwareCPU::Inst_MoveTargetForward3,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("supermove", &cHardwareCPU::Inst_SuperMove, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            ...
            tInstLibEntry<tMethod>("drop-pheromone", &cHardwareCPU::Inst_DropPheromone, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),

            // Opinion instructions.
            // These are STALLs because opinions are only relevant with respect to time.
            tInstLibEntry<tMethod>("set-opinion", &cHardwareCPU::Inst_SetOpinion, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("get-opinion", &cHardwareCPU::Inst_GetOpinion, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("get-opinionOnly", &cHardwareCPU::Inst_GetOpinionOnly_ZeroIfNone,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("clear-opinion", &cHardwareCPU::Inst_ClearOpinion, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("if-opinion-set", &cHardwareCPU::Inst_IfOpinionSet, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("if-opinion-notset", &cHardwareCPU::Inst_IfOpinionNotSet, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),

            // Data collection
            tInstLibEntry<tMethod>("if-cell-data-changed", &cHardwareCPU::Inst_IfCellDataChanged,
                                   INST_CLASS_CONDITIONAL, nInstFlag::STALL),
            tInstLibEntry<tMethod>("collect-cell-data", &cHardwareCPU::Inst_CollectCellData, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("kill-cell-event", &cHardwareCPU::Inst_KillCellEvent, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("kill-faced-cell-event", &cHardwareCPU::Inst_KillFacedCellEvent,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("collect-cell-data-and-kill-event", &cHardwareCPU::Inst_CollectCellDataAndKillEvent,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("read-cell-data", &cHardwareCPU::Inst_ReadCellData, INST_CLASS_ENVIRONMENT),
            tInstLibEntry<tMethod>("read-faced-cell-data", &cHardwareCPU::Inst_ReadFacedCellData,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("read-faced-cell-org-id", &cHardwareCPU::Inst_ReadFacedCellDataOrgID,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("read-faced-cell-freshness", &cHardwareCPU::Inst_ReadFacedCellDataFreshness,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            ...
            tInstLibEntry<tMethod>("get-faced-vitality-diff", &cHardwareCPU::Inst_GetFacedVitalityDiff,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("get-faced-org-id", &cHardwareCPU::Inst_GetFacedOrgID, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("attack-faced-org", &cHardwareCPU::Inst_AttackFacedOrg, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("get-attack-odds", &cHardwareCPU::Inst_GetAttackOdds, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),

            // Synchronization
            tInstLibEntry<tMethod>("flash", &cHardwareCPU::Inst_Flash, INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("if-recvd-flash", &cHardwareCPU::Inst_IfRecvdFlash, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("flash-info", &cHardwareCPU::Inst_FlashInfo, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("flash-info-b", &cHardwareCPU::Inst_FlashInfoB, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("reset-flash-info", &cHardwareCPU::Inst_ResetFlashInfo, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            ...
            tInstLibEntry<tMethod>("get-neighborhood", &cHardwareCPU::Inst_GetNeighborhood, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("if-neighborhood-changed", &cHardwareCPU::Inst_IfNeighborhoodChanged,
                                   INST_CLASS_CONDITIONAL, nInstFlag::STALL),


            // Reputation instructions

            tInstLibEntry<tMethod>("donate-frm", &cHardwareCPU::Inst_DonateFacingRawMaterials, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("donate-spec", &cHardwareCPU::Inst_DonateFacingRawMaterialsOtherSpecies,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("donate-if-donor", &cHardwareCPU::Inst_DonateIfDonor, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("donate-string", &cHardwareCPU::Inst_DonateFacingString, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),

            tInstLibEntry<tMethod>("get-neighbors-reputation", &cHardwareCPU::Inst_GetNeighborsReputation,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("get-reputation", &cHardwareCPU::Inst_GetReputation, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("get-raw-mat-amount", &cHardwareCPU::Inst_GetAmountOfRawMaterials,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("get-other-raw-mat-amount", &cHardwareCPU::Inst_GetAmountOfOtherRawMaterials,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("pose", &cHardwareCPU::Inst_Pose, INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("rotate-to-rep", &cHardwareCPU::Inst_RotateToGreatestReputation,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("rotate-to-rep-and-donate", &cHardwareCPU::Inst_RotateToGreatestReputationAndDonate,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("rotate-to-rep-tag", &cHardwareCPU::Inst_RotateToGreatestReputationWithDifferentTag,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("rotate-to-rep-lineage",
                                   &cHardwareCPU::Inst_RotateToGreatestReputationWithDifferentLineage,
                                   INST_CLASS_ENVIRONMENT, nInstFlag::STALL),
            tInstLibEntry<tMethod>("rotate-to-tag", &cHardwareCPU::Inst_RotateToDifferentTag, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("if-donor", &cHardwareCPU::Inst_IfDonor, INST_CLASS_CONDITIONAL, nInstFlag::STALL),
            tInstLibEntry<tMethod>("prod-string", &cHardwareCPU::Inst_ProduceString, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),

            // Group formation instructions
            tInstLibEntry<tMethod>("join-group", &cHardwareCPU::Inst_JoinGroup, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("join-next-group", &cHardwareCPU::Inst_JoinNextGroup, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("kill-group-member", &cHardwareCPU::Inst_KillGroupMember, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("orgs-in-my-group", &cHardwareCPU::Inst_NumberOrgsInMyGroup, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("orgs-in-group", &cHardwareCPU::Inst_NumberOrgsInGroup, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("number-next-group", &cHardwareCPU::Inst_NumberNextGroup, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),

            tInstLibEntry<tMethod>("join-mt-group", &cHardwareCPU::Inst_JoinMTGroup, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("join-next-mt-group", &cHardwareCPU::Inst_JoinMTGroup, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("num-mt-in-my-group", &cHardwareCPU::Inst_NumberMTInMyGroup, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("num-mt-in-group", &cHardwareCPU::Inst_NumberMTInGroup, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("num-mt-next-group", &cHardwareCPU::Inst_NumberMTNextGroup, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),

            tInstLibEntry<tMethod>("inc-tolerance", &cHardwareCPU::Inst_IncTolerance, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("dec-tolerance", &cHardwareCPU::Inst_DecTolerance, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("get-tolerance", &cHardwareCPU::Inst_GetTolerance, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("get-group-tolerance", &cHardwareCPU::Inst_GetGroupTolerance, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),

            // Network creation instructions
            tInstLibEntry<tMethod>("create-link-facing", &cHardwareCPU::Inst_CreateLinkByFacing, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("create-link-xy", &cHardwareCPU::Inst_CreateLinkByXY, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("create-link-index", &cHardwareCPU::Inst_CreateLinkByIndex, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("network-bcast1", &cHardwareCPU::Inst_NetworkBroadcast1, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("network-unicast", &cHardwareCPU::Inst_NetworkUnicast, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("network-rotate", &cHardwareCPU::Inst_NetworkRotate, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("network-select", &cHardwareCPU::Inst_NetworkSelect, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            ...
            tInstLibEntry<tMethod>("donate-res-to-deme", &cHardwareCPU::Inst_DonateResToDeme, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("point-mut", &cHardwareCPU::Inst_ApplyPointMutations, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("varying-point-mut", &cHardwareCPU::Inst_ApplyVaryingPointMutations,
                                   INST_CLASS_LIFECYCLE, nInstFlag::STALL),
            tInstLibEntry<tMethod>("point-mut-gs", &cHardwareCPU::Inst_ApplyPointMutationsGroupGS, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("point-mut-rand", &cHardwareCPU::Inst_ApplyPointMutationsGroupRandom,
                                   INST_CLASS_LIFECYCLE, nInstFlag::STALL),
            tInstLibEntry<tMethod>("join-germline", &cHardwareCPU::Inst_JoinGermline, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("exit-germline", &cHardwareCPU::Inst_ExitGermline, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("repair-on", &cHardwareCPU::Inst_RepairPointMutOn, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),
            tInstLibEntry<tMethod>("repair-off", &cHardwareCPU::Inst_RepairPointMutOff, INST_CLASS_LIFECYCLE,
                                   nInstFlag::STALL),

            // Horizontal Gene Transfer Uptake/Bonus instruction
            tInstLibEntry<tMethod>("uptake-hgt-bonus", &cHardwareCPU::Inst_HGTUptake, INST_CLASS_ENVIRONMENT,
                                   nInstFlag::STALL),

            // Must always be the last instruction in the array
            tInstLibEntry<tMethod>("NULL", &cHardwareCPU::Inst_Nop, INST_CLASS_NOP, 0,
                                   "True no-operation instruction: does nothing"),
    };
...
cHardwareCPU::cHardwareCPU(cAvidaContext &ctx, cWorld *world, cOrganism *in_organism, cInstSet *in_inst_set)
        : cHardwareBase(world, in_organism, in_inst_set), m_last_cell_data(false, 0) {
...
void cHardwareCPU::SetupMiniTraceFileHeader(Avida::Output::File &df, const int gen_id,
                                            const Apto::String &genotype) { (void) df, (void) gen_id, (void) genotype; }
...
bool cHardwareCPU::SingleProcess(cAvidaContext &ctx, bool speculative) {
    ...
    for (int i = 0; i < num_inst_exec; i++) {
        ...
        if (m_promoters_enabled && m_world->GetConfig().NO_ACTIVE_PROMOTER_EFFECT.Get() == 2 &&
            m_promoter_index == -1)
            exec = false;
        ...
        if (exec == true) {
            ...
            if (num_threads == m_threads.GetSize() + 1) {
                ...
                cerr << cur_inst.GetOp() << " " << cur_inst.GetSymbol() << " " << num_threads << " "
                     << m_threads.GetSize() << endl;
...
bool cHardwareCPU::SingleProcess_ExecuteInst(cAvidaContext &ctx, const Instruction &cur_inst) {
    ...
    if (m_world->GetConfig().TASK_SWITCH_PENALTY_TYPE.Get()) {
        if (m_organism->GetPhenotype().GetNumNewUniqueReactions()) {
            int cost = m_organism->GetPhenotype().GetNumNewUniqueReactions() *
...
void cHardwareCPU::PrintStatus(ostream &fp) {
    ...
    if (m_organism->GetPhenotype().GetTimeUsed() != m_organism->GetPhenotype().GetCPUCyclesUsed()) {
        fp << "  EnergyUsed:"
           << m_organism->GetPhenotype().GetTimeUsed(); // this is not energy that is used by the energy model
    }
    fp << endl;
    ...
    for (int stack_id = 0; stack_id < number_of_stacks; stack_id++) {
        fp << ((m_threads[m_cur_thread].cur_stack == stack_id) ? '*' : ' ') << " Stack " << stack_id << ":"
...
bool cHardwareCPU::Inst_PopA(cAvidaContext &) {
    GetRegister(REG_AX) = StackPop();
    return true;
}

bool cHardwareCPU::Inst_PopB(cAvidaContext &) {
    GetRegister(REG_BX) = StackPop();
    return true;
}

bool cHardwareCPU::Inst_PopC(cAvidaContext &) {
    GetRegister(REG_CX) = StackPop();
    return true;
}

bool cHardwareCPU::Inst_PushA(cAvidaContext &) {
    StackPush(GetRegister(REG_AX));
    return true;
}

bool cHardwareCPU::Inst_PushB(cAvidaContext &) {
    StackPush(GetRegister(REG_BX));
    return true;
}

bool cHardwareCPU::Inst_PushC(cAvidaContext &) {
    StackPush(GetRegister(REG_CX));
    return true;
}
...
bool cHardwareCPU::Inst_FlipStack(cAvidaContext &) {
    StackFlip();
    return true;
}
...
bool cHardwareCPU::Inst_SwapAB(cAvidaContext &)\
 {
    Swap(GetRegister(REG_AX), GetRegister(REG_BX));
    return true;
}

bool cHardwareCPU::Inst_SwapBC(cAvidaContext &) {
    Swap(GetRegister(REG_BX), GetRegister(REG_CX));
    return true;
}

bool cHardwareCPU::Inst_SwapAC(cAvidaContext &) {
    Swap(GetRegister(REG_AX), GetRegister(REG_CX));
    return true;
}
...
bool cHardwareCPU::Inst_CopyRegAC(cAvidaContext &) {
    GetRegister(REG_AX) = GetRegister(REG_CX);
    return true;
}

bool cHardwareCPU::Inst_CopyRegBA(cAvidaContext &) {
    GetRegister(REG_BX) = GetRegister(REG_AX);
    return true;
}
...
bool cHardwareCPU::Inst_CopyRegCA(cAvidaContext &) {
    GetRegister(REG_CX) = GetRegister(REG_AX);
    return true;
}

bool cHardwareCPU::Inst_CopyRegCB(cAvidaContext &) {
    GetRegister(REG_CX) = GetRegister(REG_BX);
    return true;
}
...
bool cHardwareCPU::Inst_MaxAlloc(cAvidaContext &ctx)   // Allocate maximal more
{
    ...
    const int alloc_size = Apto::Min((int) (m_world->GetConfig().OFFSPRING_SIZE_RANGE.Get() * cur_size),
...
bool cHardwareCPU::Inst_Kazi(cAvidaContext &ctx) {
    ...
    } else if ((int) m_world->GetConfig().KABOOM_PROB.Get() != -1 &&
               (int) m_world->GetConfig().KABOOM_HAMMING.Get() != -1) {
        //Case where both Probability and Hamming Distance are static
        percent_prob = (double) m_world->GetConfig().KABOOM_PROB.Get();
...
bool cHardwareCPU::Inst_Kazi1(cAvidaContext &ctx) {
    ...
    if ((int) m_world->GetConfig().KABOOM_PROB.Get() != -1 && (int) m_world->GetConfig().KABOOM1_HAMMING.Get() == -1) {
        ...
        distance = (get_reg_value % genome_size);
               ...
               (int) m_world->GetConfig().KABOOM1_HAMMING.Get() != -1) {
        //Case where both Probability and Hamming Distance are static
        percent_prob = (double) m_world->GetConfig().KABOOM_PROB.Get();
...
bool cHardwareCPU::Inst_Kazi2(cAvidaContext &ctx) {
    ...
    if ((int) m_world->GetConfig().KABOOM_PROB.Get() != -1 && (int) m_world->GetConfig().KABOOM2_HAMMING.Get() == -1) {
        ...
        distance = (get_reg_value % genome_size);
               ...
               (int) m_world->GetConfig().KABOOM2_HAMMING.Get() != -1) {
        //Case where both Probability and Hamming Distance are static
        percent_prob = (double) m_world->GetConfig().KABOOM_PROB.Get();
...
bool cHardwareCPU::Inst_Kazi3(cAvidaContext &ctx) {
    ...
    if ((int) m_world->GetConfig().KABOOM_PROB.Get() != -1 && (int) m_world->GetConfig().KABOOM3_HAMMING.Get() == -1) {
        ...
        distance = (get_reg_value % genome_size);
               ...
               (int) m_world->GetConfig().KABOOM3_HAMMING.Get() != -1) {
        //Case where both Probability and Hamming Distance are static
        percent_prob = (double) m_world->GetConfig().KABOOM_PROB.Get();
...
bool cHardwareCPU::Inst_Kazi4(cAvidaContext &ctx) {
    ...
    if ((int) m_world->GetConfig().KABOOM_PROB.Get() != -1 && (int) m_world->GetConfig().KABOOM4_HAMMING.Get() == -1) {
        ...
        distance = (get_reg_value % genome_size);
               ...
               (int) m_world->GetConfig().KABOOM4_HAMMING.Get() != -1) {
        //Case where both Probability and Hamming Distance are static
        percent_prob = (double) m_world->GetConfig().KABOOM_PROB.Get();
...
bool cHardwareCPU::Inst_Kazi5(cAvidaContext &ctx) {
    ...
    if ((int) m_world->GetConfig().KABOOM_PROB.Get() != -1 && (int) m_world->GetConfig().KABOOM5_HAMMING.Get() == -1) {
        ...
        distance = (get_reg_value % genome_size);
               ...
               (int) m_world->GetConfig().KABOOM5_HAMMING.Get() != -1) {
        //Case where both Probability and Hamming Distance are static
        percent_prob = (double) m_world->GetConfig().KABOOM_PROB.Get();
...
bool cHardwareCPU::Inst_RelinquishEnergyToFutureDeme(cAvidaContext &ctx) {
    double stored_energy =
            m_organism->GetPhenotype().GetStoredEnergy() * m_world->GetConfig().FRAC_ENERGY_RELINQUISH.Get();
...
bool cHardwareCPU::DoSense(cAvidaContext &ctx, int conversion_method, double base) {
    ...
    const Apto::Array<double> res_count = m_organism->GetOrgInterface().GetResources(ctx) +
                                          m_organism->GetOrgInterface().GetDemeResources(
                                                  m_organism->GetOrgInterface().GetDemeID(), ctx);
...
bool
cHardwareCPU::DoActualCollect(cAvidaContext &ctx, int bin_used, bool env_remove, bool internal_add, bool probabilistic,
                              bool unit, float nUnits) {
...
void cHardwareCPU::DoEnergyDonate(cAvidaContext &ctx, cOrganism *to_org) {
    ...
    double receiverMerit = to_org->GetPhenotype().ConvertEnergyToMerit(
            to_org->GetPhenotype().GetStoredEnergy() * to_org->GetPhenotype().GetEnergyUsageRatio());
...
void cHardwareCPU::DoEnergyDonateAmount(cAvidaContext &ctx, cOrganism *to_org, const double amount) {
    ...
    if (update_metabolic == 1) {
        double senderMerit = phenotype.ConvertEnergyToMerit(
                phenotype.GetStoredEnergy() * phenotype.GetEnergyUsageRatio());
        m_organism->UpdateMerit(ctx, senderMerit);
    }
    ...
    to_org->GetDeme()->IncreaseEnergyReceived(
            energy_received);   // Harder for phenotype to get the deme, so it's done here
...
bool cHardwareCPU::Inst_ReceiveDonatedEnergy(cAvidaContext &ctx) {
    ...
    if (phenotype.GetEnergyInBufferAmount() > 0) {
        ...
        if (m_world->GetConfig().ENERGY_SHARING_UPDATE_METABOLIC.Get() == 1) {
            double receiverMerit = phenotype.ConvertEnergyToMerit(
                    phenotype.GetStoredEnergy() * phenotype.GetEnergyUsageRatio());
...
bool cHardwareCPU::Inst_DonateEnergyFaced(cAvidaContext &ctx) {
    ...
    if ((neighbor != NULL) && (!neighbor->IsDead())) {
        ...
        if ((neighbor->GetPhenotype().HasOpenEnergyRequest()) ||
            (m_world->GetConfig().ENERGY_SHARING_METHOD.Get() == 1)) {
...
bool cHardwareCPU::Inst_RotateToMostNeedy(cAvidaContext &) {
    ...
    for (int i = 0; i < mycell.ConnectionList().GetSize(); i++) {
        ...
        if ((neighbor != NULL) && (!neighbor->IsDead()) &&
            ((neighbor->GetPhenotype().HasOpenEnergyRequest()) ||
             (m_world->GetConfig().ENERGY_SHARING_METHOD.Get() == 1))) {
...
void cHardwareCPU::DoResourceDonatePercent(cAvidaContext &ctx, const int to_cell, const int resource_id,
                                           const double frac_resource_given) {
    assert(to_cell >= 0);
...
// Note: This function doesn't work with deme-level resources.
void cHardwareCPU::DoResourceDonateAmount(cAvidaContext &ctx, const int to_cell, const int resource_id,
                                          const double amount) {
    assert(to_cell >= 0);
    assert(amount >= 0);
    assert(resource_id >= 0);
...
bool cHardwareCPU::Inst_DonateSpecific(cAvidaContext &ctx) {
    if (m_organism->GetPhenotype().GetCurNumDonates() > m_world->GetConfig().MAX_DONATES.Get() ||
        (m_world->GetConfig().MAX_DONATE_EDIT_DIST.Get() > 0 &&
         m_organism->GetPhenotype().GetCurNumDonates() > m_world->GetConfig().MAX_DONATE_EDIT_DIST.Get())) {
        return false;
    }
    if (!m_organism->IsNeighborCellOccupied()) return false;
...
bool cHardwareCPU::HeadCopy_ErrorCorrect(cAvidaContext &ctx, double reduction) {
    ...
    if (ctx.GetRandom().P(m_organism->GetCopyInsProb() / reduction))
        write_head.InsertInst(m_inst_set->GetRandomInst(ctx));
...
bool cHardwareCPU::Inst_Terminate(cAvidaContext &ctx) {
    ...
    if (no_promoter_found) {
        if ((m_world->GetConfig().NO_ACTIVE_PROMOTER_EFFECT.Get() == 0) ||
            ...
            cout << "Unrecognized NO_ACTIVE_PROMOTER_EFFECT setting: "
                 << m_world->GetConfig().NO_ACTIVE_PROMOTER_EFFECT.Get() << endl;
        }
    } else {
...
void cHardwareCPU::NextPromoter() {
    ...
    if (m_promoter_index == m_promoters.GetSize()) {
        ...
        if (m_promoter_offset + m_world->GetConfig().PROMOTER_EXE_LENGTH.Get() >
            m_world->GetConfig().PROMOTER_CODE_SIZE.Get()) {
            m_promoter_offset = 0;
        }
    }
}
...
int cHardwareCPU::Numberate(int _pos, int _dir, int _num_bits) {
    ...
    while (code_size < _num_bits) {
        ...
        for (int code_on = 0;
             (code_size < _num_bits) && (code_on < m_world->GetConfig().INST_CODE_LENGTH.Get()); code_on++) {
            if (_dir < 0) {
...
bool cHardwareCPU::Inst_Alarm_MSG_multihop(cAvidaContext &ctx) {
    const int reg_used = FindModifiedRegister(REG_BX);
    return m_organism->BcastAlarmMSG(ctx, abs(GetRegister(reg_used) % 2),
                                     m_world->GetConfig().BCAST_HOPS.Get()); // jump to Alarm-label-  odd=high  even=low
}

bool cHardwareCPU::Inst_Alarm_MSG_Bit_Cons24_multihop(cAvidaContext &ctx) {
    const int reg_used = FindModifiedRegister(REG_BX);
    return m_organism->BcastAlarmMSG(ctx, (BitCount(GetRegister(reg_used) & MASK24) >= CONSENSUS24) ? 1 : 0,
                                     m_world->GetConfig().BCAST_HOPS.Get());// jump to Alarm-label-high OR Alarm-label-low
}

bool cHardwareCPU::Inst_Alarm_MSG_local(cAvidaContext &ctx) {
    const int reg_used = FindModifiedRegister(REG_BX);
    return m_organism->BcastAlarmMSG(ctx, abs(GetRegister(reg_used) % 2),
                                     1); // jump to Alarm-label-  odd=high  even=low
}

bool cHardwareCPU::Inst_Alarm_MSG_Bit_Cons24_local(cAvidaContext &ctx) {
    const int reg_used = FindModifiedRegister(REG_BX);
    return m_organism->BcastAlarmMSG(ctx, (BitCount(GetRegister(reg_used) & MASK24) >= CONSENSUS24) ? 1 : 0,
                                     1);// jump to Alarm-label-high OR Alarm-label-low
}
...
//Get difference in vitality of this organism and faced neighbor.
{
    ...
    const int out_reg = FindModifiedRegister(REG_BX);
    // return % diff
    int vit_diff = (int) ((neighbor->GetVitality() - m_organism->GetVitality()) / m_organism->GetVitality() * 100 +
                          0.5);
    GetRegister(out_reg) = vit_diff;
    return true;
}
...
bool cHardwareCPU::Inst_ApplyVaryingPointMutations(cAvidaContext &ctx) {
    ...
    if (last_task != -1) {
        ...
        double point_mut_prob =
                m_world->GetConfig().INST_POINT_MUT_PROB.Get() * m_world->GetConfig().INST_POINT_MUT_SLOPE.Get() *
                last_task;
        int num_mut = m_organism->GetHardware().PointMutate(ctx, point_mut_prob);
        m_organism->IncPointMutations(num_mut);
    }
...
bool cHardwareCPU::Inst_SetMatingTypeMale(cAvidaContext &) {
    ...
    if (m_organism->GetPhenotype().GetMatingType() == MATING_TYPE_FEMALE) {
        ...
        if (m_organism->GetOrgInterface().HasOpinion(m_organism)) {
            ...
            m_organism->GetOrgInterface().ChangeGroupMatingTypes(m_organism, m_organism->GetOpinion().first, old_type,
                                                                 1);
        }
...
bool cHardwareCPU::Inst_SetMatePreferenceRandom(cAvidaContext &ctx) {
    return Inst_SetMatePreference(ctx, MATE_PREFERENCE_RANDOM);
}

bool cHardwareCPU::Inst_SetMatePreferenceHighestDisplayA(cAvidaContext &ctx) {
    return Inst_SetMatePreference(ctx, MATE_PREFERENCE_HIGHEST_DISPLAY_A);
}

bool cHardwareCPU::Inst_SetMatePreferenceHighestDisplayB(cAvidaContext &ctx) {
    return Inst_SetMatePreference(ctx, MATE_PREFERENCE_HIGHEST_DISPLAY_B);
}

bool cHardwareCPU::Inst_SetMatePreferenceHighestMerit(cAvidaContext &ctx) {
    return Inst_SetMatePreference(ctx, MATE_PREFERENCE_HIGHEST_MERIT);
}

bool cHardwareCPU::Inst_SetMatePreferenceLowestDisplayA(cAvidaContext &ctx) {
    return Inst_SetMatePreference(ctx, MATE_PREFERENCE_LOWEST_DISPLAY_A);
}

bool cHardwareCPU::Inst_SetMatePreferenceLowestDisplayB(cAvidaContext &ctx) {
    return Inst_SetMatePreference(ctx, MATE_PREFERENCE_LOWEST_DISPLAY_B);
}

bool cHardwareCPU::Inst_SetMatePreferenceLowestMerit(cAvidaContext &ctx) {
    return Inst_SetMatePreference(ctx, MATE_PREFERENCE_LOWEST_MERIT);
}

// Uptake a gene fragment
//
// - HGT_UPTAKE_RECOMBINATION_P config option determines the probability of attempting a recombination
//
// - HGT_UPTAKE_HOMOLOGOUS_MATCH config options sets how much starting/ending fragment overlap there must be for
//   a successful recombination
//
// - If above probability fails (no recombination), bonus is determined by the HGT Uptake Bonus task, as defined
//   in the environment.cfg file. No bonus defined in the env file means there's no magic.
//
bool cHardwareCPU::Inst_HGTUptake(cAvidaContext &ctx) {

    if (!m_world->GetConfig().ENABLE_HGT.Get() ||
        m_organism->GetCellID() < 0) // in case of weirdness where there's no world.
        return false;
...
//      ctx.Driver().Feedback().Driver().Feedback().Error("HGT_SOURCE is set to an invalid value.");
    ...
    if (ctx.GetRandom().P(m_world->GetConfig().HGT_UPTAKE_RECOMBINATION_P.Get())) {
        ...
        m_organism->GetHGTUptakenFragments().Push(frag);
        // todo - add the later analysis
        ...
        // is there a genome fragment out there that we can eat?
        if (m_organism->GetCellID() < 0 ||
            m_world->GetPopulation().GetCell(m_organism->GetCellID()).CountGenomeFragments() < 1) {
            return false;
        }
        ...
        //we're outputting just to trigger reaction checks
        m_organism->DoOutput(ctx, 0);
        m_organism->GetPhenotype().SetHGTUptakeBonusExecuted(false); // clean up!
