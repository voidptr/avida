...
private:
  ...
  unsigned char m_mating_display_c; //@RCK
...
public:
  ...
  void SetMatingDisplayC(unsigned char _mating_display_c) { m_mating_display_c = _mating_display_c; } //@RCK
  ...
  unsigned char GetMatingDisplayC() const { return m_mating_display_c; }
